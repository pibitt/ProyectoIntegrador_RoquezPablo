...
import com.portfolio.pablo.Dto.dtoPersonaNuevo;
import com.portfolio.pablo.Security.Controller.Mensaje;
import com.portfolio.pablo.Service.SPersonaNuevo;
...
public class CPersonaNuevo {
    ...
    public ResponseEntity<?> create(@RequestBody dtoPersonaNuevo dtopers) {
        ...
        PersonaNuevo persona = new PersonaNuevo(dtopers.getNombreP(), dtopers.getDescP(), dtopers.getImgP(), dtopers.getTituloP(), dtopers.getImgPortada(), dtopers.getApellidoP());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoPersonaNuevo dtopers) {
        ...
        personaNuevo.setDescP(dtopers.getDescP());
        personaNuevo.setTituloP(dtopers.getTituloP());
        personaNuevo.setImgP(dtopers.getImgP());
        personaNuevo.setImgPortada(dtopers.getImgPortada());
