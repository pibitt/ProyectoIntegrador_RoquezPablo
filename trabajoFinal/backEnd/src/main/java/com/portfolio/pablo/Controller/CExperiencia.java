...
public class CExperiencia {
    ...
    @GetMapping("/lista")
    public ResponseEntity<List< ExperienciaMati>> list() {
        List<ExperienciaMati> list = sExperiencia.list();
        return new ResponseEntity(list, HttpStatus.OK);
    }

    @GetMapping("/detail/{id}")
    public ResponseEntity<ExperienciaMati> getById(@PathVariable("id") int id) {
